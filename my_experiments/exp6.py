...
checkpointer = ModelCheckpoint(filepath="./tmpdata/weights_exp6.h5", save_best_only=True, verbose =1 )
...
open('./tmpdata/convnet_architecture_exp6.json', 'w').write(json_string)
