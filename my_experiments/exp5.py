...
conv2 = Convolution1D(nb_filter = 32, filter_length = 10, border_mode='valid',
...
checkpointer = ModelCheckpoint(filepath="./tmpdata/weights_exp5.h5", save_best_only=True, verbose =1 )
...
open('./tmpdata/convnet_architecture_exp5.json', 'w').write(json_string)
