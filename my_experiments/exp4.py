...
X_valid = np.empty((50*num_seq_per_batch, seq_length))
Y_valid = np.empty((50*num_seq_per_batch, 3))
...
dense4 = Dense(512, activation = 'relu', init= 'normal')(flat)
...
checkpointer = ModelCheckpoint(filepath="./tmpdata/weights_exp4.h5", save_best_only=True)
...
open('./tmpdata/convnet_architecture_exp4.json', 'w').write(json_string)
