...
conv1_avgpooling = AveragePooling1D(pool_length=2, stride=None, border_mode='valid')(conv1)
conv2 = Convolution1D(nb_filter = 32, filter_length = 4, border_mode='valid',
                      init = 'normal', activation =  'relu')(conv1_avgpooling)
conv2_maxpooling = MaxPooling1D(pool_length=2, stride=None, border_mode='valid')(conv2)
conv3 = Convolution1D(nb_filter = 64, filter_length = 4, border_mode='valid',
